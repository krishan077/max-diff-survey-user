...
export class SurveyQuestionComponent {
  ...
  worstDisclamer:disclamer = {id:'',imageUrl:'',name:''};
  bestDisclamer:disclamer  = {id:'',imageUrl:'',name:''};
  ...
  handleConceptClick(conceptId: string, type: 'best' | 'worst' , conceptIndex:number) {
    if (type === 'best') {
      if (this.bestChoice === conceptId) {
        ...
        if(conceptIndex != null && this.concepts  && this.concepts[conceptIndex].imageUrl) this.bestDisclamer = this.concepts[conceptIndex];
      ...
      if (this.worstChoice === conceptId) {
        ...
        if(conceptIndex != null && this.concepts && this.concepts[conceptIndex].imageUrl) this.worstDisclamer = this.concepts[conceptIndex];
